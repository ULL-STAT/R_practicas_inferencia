...
#===========================================================================================
actividad<-HIPER200$act_fisi             #se copia la variable en actividad
levels(actividad)<-c("escasa", "moderada","moderada")   #se recodifica via los niveles del factor dando el mismo nombre
#table(a_f,act_fisi)   #para comprobación
...
# de los indviduos que toman una cantidad normal de sal (sal=="normal") es menor que el peso medio
# de los indviduos que toman mucha cantidad de sal (sal=="mucha")
