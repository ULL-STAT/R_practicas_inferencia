...
#IC para la diferencia de medias con varianzas desconocidas y distintas
...
BinomCI(x=18, n=106, conf.level=0.95, method="wald")   # IC para la diferencia de proporciones según Wald
...
# IC para la diferencia de proporciones según Wilson
table(sal,genero)
margin.table(table(sal,genero),2)
